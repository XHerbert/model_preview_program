...
webUtils.getViewtoken(1958634555950048, INTEGRATE_FILE).then((token) => {
...
function bindEvent() {
    ...
    document.getElementById('copy_c').addEventListener('click', function () {
        let copy_c = viewer.getSelectedComponents();
        console.log(copy_c);
    })
}